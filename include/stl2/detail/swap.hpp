    ...
    struct fn {
      ...
      requires
        ...
        requires(T&& t, U&& u, DT&& dt, DU&& du) {
          t = __stl2::proxy_move((U&&)u);
          u = __stl2::proxy_move((T&&)t);
          t = (DU&&)du;
          u = (DT&&)dt;
        }
      constexpr void operator()(T&& t, U&& u) const
      noexcept(is_nothrow_constructible<DT, PMT>::value &&
               ...
               noexcept(t = __stl2::proxy_move((U&&)u)) &&
               noexcept(u = __stl2::proxy_move((T&&)t)) &&
               noexcept(t = __stl2::declval<DU&&>()) &&
               noexcept(u = __stl2::declval<DT&&>()))
      {
